...
console.log(`funcionario1: ${descontoFuncionario1}`)
console.log(`funcionario2: ${descontoFuncionario2}`)
 */
...
console.log(
    `
    Salario funcionario1: ${funcionario1.nome} : ${funcionario1.salarioLiquido}
    Salario funcionario2 ${funcionario2.nome} : ${funcionario2.salarioLiquido}
    `)