...
class Tela {
    static obterCodigoHtml(item) {
        return `
        <div class="col-md-3">
            <div class="card" style="width: 50%; margin:auto;" onclick = "window.verificarSelecao('${item.id}', '${item.nome}')">
    ...
    static iniciarContador() {
        ...
        //vamos criar uma funcao em linha para atualizar o texto a cada segundo
